...
import com.gmdinnovacion.beneficiosgmd.disfruta.view.fragment.CategoriasFavoritoFragment;
...
public class AdapterFavoritoCategoria extends RecyclerView.Adapter<AdapterFavoritoCategoria.CategoriasFragmen>
{
...
//    List<String> imagenesCategorias;
    ...
    CategoriasFavoritoFragment context;

    public AdapterFavoritoCategoria(CategoriasFavoritoFragment context, List<Categoria> itemList) {
