...
public class CategoriasFragment extends DialogFragment implements AdapterCategoria.OnItemClickListener {
    ...
    public CategoriasFragment(Handler handler) {
...
//        manager = new GridLayoutManager(contexr, 3);
        ...
        AdapterCategoria rcAdapter = new AdapterCategoria(this, allItems);
