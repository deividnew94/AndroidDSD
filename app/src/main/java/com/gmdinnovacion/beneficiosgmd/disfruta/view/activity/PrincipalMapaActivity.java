...
import com.gmdinnovacion.beneficiosgmd.disfruta.view.fragment.ListaMapaFragment;
import com.gmdinnovacion.beneficiosgmd.disfruta.view.fragment.TabsPushMensajeT;
import com.gmdinnovacion.beneficiosgmd.disfruta.view.fragment.UsuarioFragment;
...
public class PrincipalMapaActivity extends AppCompatActivity {
    ...
    @BindView(R.id.icon_tab_options)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragments.add(ListaMapaFragment.newInstance("1", data));
        fragments.add(ListaDetalleFavoritoDscto.newInstance("2"));
        fragments.add(TabsPushMensajeT.newInstance("1"));
        fragments.add(UsuarioFragment.newInstance("1"));
    ...
    void initTab(){
        ...
        ((ImageView)viewTab2.findViewById(R.id.icon_tab_options)).setColorFilter(getResources().getColor(R.color.red_tab_selected_icon), PorterDuff.Mode.SRC_IN);
        View viewTab3 = tabLayout.getTabAt(2).getCustomView();
        ((ImageView)viewTab3.findViewById(R.id.icon_tab_options)).setColorFilter(getResources().getColor(R.color.red_tab_selected_icon), PorterDuff.Mode.SRC_IN);
        View viewTab4 = tabLayout.getTabAt(3).getCustomView();
        ((ImageView)viewTab4.findViewById(R.id.icon_tab_options)).setColorFilter(getResources().getColor(R.color.red_tab_selected_icon), PorterDuff.Mode.SRC_IN);
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_principal_mapa, container, false);
