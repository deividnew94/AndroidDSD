...
public class AdapterDetalleFavoritoDescuento extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterDetalleFavoritoDescuento(Context context){
